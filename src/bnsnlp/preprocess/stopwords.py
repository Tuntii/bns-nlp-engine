...
TURKISH_STOP_WORDS = {
    ...
    # Conjunctions
    've', 'veya', 'ya', 'ile', 'ama', 'fakat', 'ancak', 'lakin',
    'ki', 'de', 'da', 'mi', 'mı', 'mu', 'mü',
    
    # Prepositions
    'için', 'gibi', 'kadar', 'göre', 'üzere', 'dolayı',
    'ile', 'den', 'dan', 'ten', 'tan',
    
    # Common verbs and auxiliaries
    'var', 'yok', 'olan', 'olarak', 'oldu', 'olur',
    'etti', 'eder', 'etmek', 'olmak',
    'dır', 'dir', 'dur', 'dür', 'tır', 'tir', 'tur', 'tür',
    
    # Question words
    'ne', 'neden', 'niçin', 'nasıl', 'nerede', 'nereye', 'nereden',
    'kim', 'kime', 'kimi', 'kimin', 'kimse',
    'hangi', 'hangisi',
    
    # Time and quantity
    'şimdi', 'sonra', 'önce', 'daha', 'en', 'çok', 'az', 'hiç',
    'hep', 'her', 'bazı', 'birkaç', 'tüm', 'bütün',
    
    # Common adverbs
    'çok', 'az', 'daha', 'en', 'pek', 'oldukça', 'fazla',
    'bile', 'sadece', 'yalnız', 'yalnızca', 'ancak',
    'belki', 'mutlaka', 'kesinlikle',
    
    # Negation
    'değil', 'yok', 'hiç',
    
    # Other common words
    'şey', 'yer', 'zaman', 'kez', 'kere',
    'gibi', 'kadar', 'beri', 'itibaren',
    'hem', 'ya', 'veya', 'yahut',
    'ise', 'eğer', 'madem',
}
